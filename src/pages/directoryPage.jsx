...
const works = [
	...
	{ title: "Artificial Divinities", artist: "Ha Thao", thumb: "/assets/THE CHRONICLE OF ARTIFICIAL DIVINITY - Thảo Hà.png", path: "/ha-thao" },
	{ title: "you’re so exotic looking!", artist: "Han Đao", thumb: "/assets/you are so exotic looking! - Hân Đào.png", path: "/han-dao-you-are-so-exotic-looking" },
	{ title: "đàn-ông.exe", artist: "Han Đao", thumb: "/assets/Đàn ông - Hân Đào.png", path: "/han-dao-dan-ong" },
	{ title: "G9", artist: "Ivy Vo", thumb: "/assets/G9 - Ivy Vo.png", path: "/ivy-vo" },
	{ title: "Giấc mơ gi (cha)Pi ti", artist: "Le Thanh Thao", thumb: "/assets/Giac mo Chapiti - Le Thanh Thao.png", path: "/le-thanh-thao" },
	{
	...
	{ title: "Derivative of Trio A", artist: "Lyon Nguyen", thumb: "/assets/Derivative of Trio A - Lyon Nguyễn.png", path: "/lyon-nguyen" },
