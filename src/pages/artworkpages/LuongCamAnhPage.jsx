    ...
    <>
      ...
      <div className="camanhsection">
        ...
        <hr
          style={{
            border: "none",
            borderTop: "1px solid rgba(247, 252, 197, 0.9)",
            margin: "12px 0",
            opacity: 0.8,
          }}
        />

        <p>1. Hartmut Neven & Elham Kashefi, conversation, “Quantum × AI: Shaping What’s Next,” Sensing Quantum Symposium, LAS Art Foundation, Berlin, October 25, 2025, personal communication.</p>
        <p>2. International Committee of the Red Cross. (2025, April 11). Submission to the United Nations Secretary-General on artificial intelligence in the military domain (RE: ODA/2025-00029/AIMD) (pp. 2–3). ICRC</p>
      </div>
    </>
  );
}
